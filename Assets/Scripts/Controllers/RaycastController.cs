...
public class RaycastController : MonoBehaviour {
	...
	public void UpdateRaycastOrigins() {
		...
		raycastOrigins.bottomLeftInner = new Vector2 (corners[4].transform.position.x , corners[0].transform.position.y );
		raycastOrigins.bottomRightInner = new Vector2 (corners[5].transform.position.x , corners[1].transform.position.y);
	}
